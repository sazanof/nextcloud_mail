OC.L10N.register(
    ...
    "_{count} attachment_::_{count} attachments_" : ["{count} вложение","{count} вложения","{count} вложений","{count} вложений"],
    "_View more {count} attachment_::_View more {count} attachments_" : ["Показать еще {count} вложение","Показать еще {count} вложения","Показать еще {count} вложений","{count} вложений"],
    "View less attachments" : "Показать меньше вложений"
},
