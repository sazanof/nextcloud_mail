OC.L10N.register(
    ...
    "Editor layout style" : "Стиль расположения редактора",
    "Balloon style" : "Всплывающий стиль",
    "Classic style" : "Классический стиль",
    "Editor extended settings": " Расширенные возможности визуального редактора",
    "Use more formatting options": "Использовать больше возможностей форматирования",
    "Switching the modes of operation of the text editor and enabling advanced formatting features.": "Переключение режимов работы текстового редактора и включение расширенных возможностей форматирования.",
    ...
    "Clear mailbox" : "Очистить папку",
    "Clear mailbox {name}": "Очистить папку {name}",
    "All messages in folder will be deleted." : "Все письма в папке будут удалены.",
    ...
    "Error when deleting and deprovisioning accounts for \"{domain}\"" : "Возникла ошибка при удалении и отключении аккаунтов для \"{домен}\"",
    "_Successfully provisioned {count} account._::_Successfully provisioned {count} accounts._" : ["Успешно подключён {число} аккаунт.","Успешно подключено {число} аккаунтов.","Успешно подключено {число} аккаунтов.","Успешно подключено {число} аккаунтов."],
    "Anti Spam" : "Анти-Спам",
